...
export const MeetingsListContainer = styled.div<{ $isDark: boolean }>`
  display: flex;
  flex-direction: column;
  gap: 16px;
  padding: 16px;
...
export const MeetingItem = styled.div<{ $isDark: boolean; isActive?: boolean }>`
  display: flex;
  flex-direction: column;
  gap: 8px;
  padding: 16px;
  background: ${(props) =>
    props.$isDark ? 'rgba(15, 23, 42, 0.6)' : 'rgba(241, 245, 249, 0.6)'};
  border-radius: 8px;
  border: 1px solid
    ${(props) =>
      props.$isDark ? 'rgba(51, 65, 85, 0.4)' : 'rgba(226, 232, 240, 0.4)'};
  transition: all 0.2s ease;
...
export const MeetingTime = styled.div<{ $isDark: boolean }>`
  display: flex;
  align-items: center;
  gap: 8px;
...
export const MeetingTimeText = styled.span<{ $isDark: boolean }>`
  color: ${(props) => (props.$isDark ? '#e2e8f0' : '#1e293b')};
  font-weight: 600;
`;

export const MeetingDetails = styled.div<{ $isDark: boolean }>`
  display: flex;
  flex-direction: column;
  gap: 4px;
`;

export const MeetingTitle = styled.h3<{ $isDark: boolean }>`
  margin: 0;
...
export const MeetingInfo = styled.p<{ $isDark: boolean }>`
  margin: 0;
  color: ${(props) => (props.$isDark ? '#94a3b8' : '#64748b')};
  font-size: 14px;
`;
...
// Timeline Components
export const TimelineContainer = styled.div<{ $isDark: boolean }>`
  position: relative;
  padding: 20px 0;
  margin: 20px 0;
`;

export const TimelineLine = styled.div<{ $isDark: boolean }>`
  position: absolute;
  left: 50%;
  ...
  height: 100%;
  background: ${(props) =>
    props.$isDark ? 'rgba(148, 163, 184, 0.3)' : 'rgba(226, 232, 240, 0.8)'};
`;

export const CurrentTimeIndicator = styled.div<{ $isDark: boolean }>`
  position: absolute;
  left: 50%;
  transform: translateX(-50%);
  width: 12px;
  height: 12px;
  border-radius: 50%;
  background: ${(props) => (props.$isDark ? '#3b82f6' : '#2563eb')};
  box-shadow: 0 0 0 4px
    ${(props) =>
      props.$isDark ? 'rgba(59, 130, 246, 0.2)' : 'rgba(37, 99, 235, 0.2)'};
`;

export const TimeSlot = styled.div<{ $isDark: boolean }>`
  position: absolute;
  left: 0;
  right: 0;
  height: 40px;
...
export const TimeLabel = styled.span<{ $isDark: boolean }>`
  position: absolute;
  left: 60%;
...
export const ThemeToggleContainer = styled.div<{ $isDark: boolean }>`
  display: flex;
  align-items: center;
  gap: 12px;
  padding: 8px 16px;
...
export const ToggleLabel = styled.label<{ $isDark: boolean }>`
  position: relative;
  display: inline-block;
  width: 48px;
  height: 24px;
...
export const ToggleSlider = styled.span<{ $isDark: boolean }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
