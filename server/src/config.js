...
const envSchema = zod_1.z.object({
    ...
    SPOTIFY_CLIENT_SECRET: zod_1.z.string().min(1, 'SPOTIFY_CLIENT_SECRET is required'),
    SPOTIFY_REDIRECT_URI: zod_1.z.string().min(1, 'SPOTIFY_REDIRECT_URI is required'),
});
